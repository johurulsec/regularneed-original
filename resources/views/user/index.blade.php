...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Welcome to Regular Need, <span
                    style="color: #008b00">{{ auth()->user()->name }}!</span></h1>
        </div>
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    ...
                                    {{ App\Models\Order::where('user_id', auth()->id())->count() }} Orders
                                </div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    ৳
                                    {{ number_format(App\Models\Order::where('user_id', auth()->id())->where('status', 'delivered')->sum('total_amount'), ) }}
                                </div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    {{ App\Models\ProductReview::where('user_id', auth()->id())->count() }} Reviews
                                </div>
                            </div>
                            <div class="col-auto">
