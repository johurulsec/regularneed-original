...
<footer class="footer">
    <!-- Footer Top -->
    <div class="footer-top section" style="background-color: #28a745;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 col-12">
                    ...
                    <div class="single-footer links">
                        ...
                        <ul>
                            ...
                            <li><a href="{{ route('refund-policy') }}">Returns & Refunds</a></li>
            ...
            <div class="inner">
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="left">
                            <p>Copyright © {{ date('Y') }} <a href="{{ route('home') }}" target="_blank">Regular
                                    Need</a>
