...
@endsection
@section('title', 'E-commerce || PRODUCT DETAIL')
                                ...
                                <div class="flexslider-thumbnails">
                                    <ul class="slides">
                                        ...
                                        @foreach ($photo as $data)
                                            @php
                                                $image = asset($data); // public folder থেকে URL generate
                                            @endphp
                                            <li data-thumb="{{ $image }}" rel="adjustX:10, adjustY:">
                                ...
                                <div class="product-buy">
                                    <form action="{{ route('single-add-to-cart') }}" method="POST">
                                        ...
                                        <div class="add-to-cart mt-4">
                                            ...
                                            <a href="{{ route('checkout') }}" class="btn">Buy Now</a>
                                    ...
                                    <p class="cat">
                                        Category :
                                        <a
                                            href="{{ route('product-cat', optional($product_detail->cat_info)->slug ?? '#') }}">
                                            {{ optional($product_detail->cat_info)->title ?? 'No Category' }}
                                        </a>
                                    </p>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href="{{ route('product-detail', $data->slug) }}">
                                            ...
                                            @endphp
                                            <img class="default-img" src="{{ $image }}" alt="{{ $data->title }}">
                                            <img class="hover-img" src="{{ $image }}" alt="{{ $data->title }}">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="quickview-content">
                                ...
                                <div class="add-to-cart">
                                    <a href="#" class="btn"><svg style="margin-left: 10px; margin-top: 10px;"
