                    ...
                    <div class="col-lg-8 col-12">
                        <div class="checkout-form">
                            ...
                            @php
                                ...
                                // ইউজারের Latest Order
                                $latestOrder = \App\Models\Order::where('user_id', $user->id)
                                    ->latest()
                                    ->first();

                                // যদি অর্ডার না থাকে → শুধু email show করবে
                                if (!$latestOrder) {
                                    $formData = [
                                        'first_name' => '',
                                        'last_name' => '',
                                ...
                                // যদি অর্ডার থাকে → সব order table থেকে আসবে
                                else {
                                    $formData = [
                                        ...
                                        'country' => $latestOrder->country ?? 'BD',
                                        'address1' => $latestOrder->address1,
                                        'address2' => $latestOrder->address2,
                                        'post_code' => $latestOrder->post_code,
                                    ];
                                }
                            @endphp
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <label>Phone Number<span>*</span></label>
                                        <input type="text" name="phone" value="{{ old('phone', $formData['phone']) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        <label>Country<span>*</span></label>
                                        <select name="country">
                                            <option value="BD" {{ $formData['country'] == 'BD' ? 'selected' : '' }}>
                                                Bangladesh
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address1"
                                            value="{{ old('address1', $formData['address1']) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="address2"
                                            value="{{ old('address2', $formData['address2']) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="post_code"
                                            value="{{ old('post_code', $formData['post_code']) }}">
                                    </div>
                                </div>
                        ...
                        <div class="order-details">
                            ...
                            <div class="single-widget">
                                ...
                                <div class="content">
                                    <div class="checkbox ">
                                        <form-group>
                                            <input name="payment_method" type="radio" value="cod" checked> <label> Cash On
                                                Delivery</label><br>
                                        </form-group>
                                        <span style="color:red;">Note: <p>Order today and receive it within 02 - 03
                                                days.</br>
