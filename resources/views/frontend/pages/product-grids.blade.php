            ...
            <div class="container">
                <div class="row">
                            ...
                            <div class="single-widget recent-post">
                                ...
                                @foreach ($recent_products as $product)
                                    @php
                                        ...
                                        $image = isset($photo[0]) && $photo[0] != '' ? asset($photo[0]) : asset('backend/img/product/default.png');
                                    @endphp
                    ...
                    <div class="col-lg-9 col-md-8 col-12">
                                                ...
                                                <div class="button-head">
                                                    ...
                                                    <div class="product-action-2">
                                                        ...
                                                        <a title="Add to cart" href="{{ route('add-to-cart', $product->slug) }}">
                                                            <svg style="margin-left: 10px; margin-top: 10px;"
                        ...
                        <div class="row">
                            <div class="col-md-12 justify-content-center d-flex">
                                {{-- Pass 'pagination::bootstrap-4' to the links() method --}}
