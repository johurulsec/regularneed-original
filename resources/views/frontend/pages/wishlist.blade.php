                        ...
                        <tbody>
                            @if (Helper::getAllProductFromWishlist())
                                @foreach (Helper::getAllProductFromWishlist() as $key => $wishlist)
                                    @php
                                        $photoArray = explode(',', $wishlist->product['photo']);
                                        $image = asset(trim($photoArray[0])); // convert relative path to full URL
                                    @endphp
                                    <tr>
                                        <td class="image" data-title="No">
                                            <img src="{{ $image }}" alt="{{ $wishlist->product['title'] }}">
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ route('add-to-cart', $wishlist->product['slug']) }}" class='btn text-white'>
                                                Add To Cart
                                            </a>
                                        </td>
