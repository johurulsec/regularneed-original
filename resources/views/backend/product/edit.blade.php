                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div id="preview" style="margin-top:15px; max-height:100px;">
                            @if ($product->photo && file_exists(public_path($product->photo)))
                                <img id="preview-img" src="{{ asset($product->photo) }}" alt="Preview"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select name="size[]" class="form-control selectpicker" multiple data-live-search="true">
                            ...
                            <option value="S" @if (in_array('S', $sizes)) selected @endif>Small</option>
                            <option value="M" @if (in_array('M', $sizes)) selected @endif>Medium</option>
                            <option value="L" @if (in_array('L', $sizes)) selected @endif>Large</option>
                            <option value="XL" @if (in_array('XL', $sizes)) selected @endif>Extra Large</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div id="preview" style="margin-top:15px; max-height:100px;">
                            @if ($product->photo && file_exists(public_path($product->photo)))
                                <img id="preview-img" src="{{ asset($product->photo) }}" style="max-height:100px;">
                            @else
                                <img id="preview-img" src="#" style="max-height:100px; display:none;">
                            @endif
                        </div>
                        @error('photo')
                            <span class="text-danger">{{ $message }}</span>
