...
@section('title', 'E-commerce || Banner Page')
                        ...
                        <tbody>
                            @foreach ($banners as $banner)
                                <tr>
                                    ...
                                    <td>{{ $banner->slug }}</td>
                                    <td>
                                        @if (!empty($banner->photo) && file_exists(public_path($banner->photo)))
                        ...
                        <tbody>
                            @foreach ($banners as $banner)
                                <tr>
                                    ...
                                    <td>
                                        @if ($banner->category)
                                            <a href="{{ route('category.show', $banner->category->slug) }}">
                                    ...
                                    <td>
                                        @if ($banner->status == 'active')
                                            <span class="badge badge-success">{{ ucfirst($banner->status) }}</span>
                                        @else
                                            <span class="badge badge-warning">{{ ucfirst($banner->status) }}</span>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{ route('banner.edit', $banner->id) }}"
