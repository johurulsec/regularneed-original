...
<ul class="navbar-nav sidebar  sidebar-dark accordion" id="accordionSidebar" style="background: #2e2d2d;">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admin') }}">
        ...
        <div class="sidebar-brand-text mx-3">
            <img src="@foreach ($settings as $data) {{ asset($data->logo) }} @endforeach" alt="logo" height="60"
                width="180">
        </div>
    </a>
    ...
    <!-- Advertisements -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#advertisementCollapse"
            aria-expanded="true" aria-controls="advertisementCollapse">
            <i class="fas fa-ad"></i>
            <span>Advertisements</span>
        </a>
        <div id="advertisementCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Advertisement Options:</h6>
                <a class="collapse-item" href="{{ route('ads.index') }}">All Advertisements</a>
                <a class="collapse-item" href="{{ route('ads.create') }}">Add Advertisement</a>
    ...
    {{-- <!-- Subscriptions -->
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#subscriptionsCollapse"
            aria-expanded="true" aria-controls="subscriptionsCollapse">
            <i class="fas fa-ad"></i>
            <span>Subscriptions</span>
        </a>
        <div id="subscriptionsCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Subscriptions Options:</h6>
